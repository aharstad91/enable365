...
// Logo size - percentage based for responsive scaling
// Images will scale within their grid cell
switch ($logo_size) {
    case 'sm':
        $img_classes = 'w-full max-w-[120px] lg:max-w-[140px] h-auto';
        break;
    case 'md':
        $img_classes = 'w-full max-w-[180px] lg:max-w-[200px] h-auto';
        break;
    case 'lg':
        $img_classes = 'w-full max-w-[220px] lg:max-w-[260px] h-auto';
        break;
    default:
        $img_classes = 'w-full max-w-[180px] lg:max-w-[200px] h-auto';
}
        ...
        <div class="<?php echo esc_attr(implode(' ', $grid_classes)); ?>">
            <?php foreach ($logos as $logo):
                ...
                $img_html = wp_get_attachment_image(
                    ...
                    false,
                    [
                        'class' => $img_classes . ' object-contain',
                        'alt' => $name ?: ($image['alt'] ?? ''),
                    ]
                );
            ?>
