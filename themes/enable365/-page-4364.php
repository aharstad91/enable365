<?php 
/**
 * Blog Archive Page Template - Modern Tailwind Design
 * Inspired by single-blog.php layout with improved UX
 */
get_header(); 
the_post();
  ...
  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
	...
	<div class="flex items-center justify-between mb-8">
	  ...
	  <div class="text-sm text-slate-600">
		<?php
		$total_posts = wp_count_posts('blog')->publish;
		echo esc_html($total_posts) . ' ' . ($total_posts == 1 ? 'innlegg' : 'innlegg');
		?>
	  </div>
	</div>
	...
	$args = array(
	  'post_type' => 'blog',
	  'posts_per_page' => 12, // Changed from -1 to enable pagination
	  'orderby' => 'date',
