...
<div class="max-w-[1280px] mx-auto">
    ...
    <div class="mb-8 bg-white pt-8 pb-8">  
      <div class="text-[36px] font-bold"><?php echo esc_html($showcase_title); ?></div>
    </div>
    <?php endif; ?>
    <div class="flex flex-col lg:flex-row gap-8 lg:gap-32">
      <div class="text-column w-full lg:w-1/2 space-y-24 lg:space-y-80">
        ...
        ?>
            <section class="step" data-image="<?php echo $image_url; ?>"<?php echo $last_step_style; ?>>
                <div>
                  <img decoding="async" src="<?php echo $image_url; ?>" alt="<?php echo isset($image['alt']) ? esc_attr($image['alt']) : ''; ?>" class="lg:hidden w-full rounded mb-4">
                  <?php if ($icon) : ?>
                  <img decoding="async" width="<?php echo isset($icon['width']) ? esc_attr($icon['width']) : '339'; ?>" height="<?php echo isset($icon['height']) ? esc_attr($icon['height']) : '112'; ?>" src="<?php echo esc_url($icon['url']); ?>" alt="<?php echo isset($icon['alt']) ? esc_attr($icon['alt']) : ''; ?>" class="mb-4" style="width: 124px;">
                  <?php endif; ?>
      ...
      <div class="image-column hidden lg:block w-1/2">
        ...
        <img id="sticky-image" class="sticky top-[300px] w-full rounded" src="<?php echo esc_url($first_image['url']); ?>" alt="<?php echo isset($first_image['alt']) ? esc_attr($first_image['alt']) : ''; ?>">
        <?php else : ?>
        <img id="sticky-image" class="sticky top-[300px] w-full rounded" src="" alt="Showcase Image">
        <?php endif; ?>
      </div>
    </div>
</div>
